...
status, notes, top_results, bottom_results = wave.Analyse(display = True, output_directory = '', background_span = 25, distance_threshold = 10, fit_window_span = 10, peak_threshold_multiplier = 15.0)
